<!-- ***********************************************************************************
  ...
  Program #  : 4
  Purpose    : Controller backend program for program 4. takes data from backend and cretaes a conection to mysql database. It sends the user to the right program according to the pressed button.
  Due Date   : 7/16/2022
...
<html>
    ...
    <body>
        ...
        <?php
            ...
            include( "Program4.php" );//recalling the front-end after backend is excuted
